...
from config import GROQ_API_KEY, MAX_CHAT_HISTORY, WIKI_DIR
...
def _build_messages(user_id: int, message_text: str, is_group: bool = False,
    ...
    if extra and not is_group:
        extra_section = f"ADDITIONAL CONTEXT (relevant to this question):\n{extra}"
...
def _maybe_learn(message_text: str):
    ...
    triggers = [
        ...
        "remember that", "don't forget", "i started", "i plan",
